...
require 'builtinmodule.urlcode'
store = require 'builtinmodule.store'
athena = {}
token = {}
api = {}
...
function api.update(api, params)
   local data = urlcode.encodeTable(params.web)
...
----------------------------------------------------------------------------------
-- Substitutes the approrpriate path variables into the api
-- @params api: The api call being made

...
-- http://training.interfaceware.com/course/XXXXXXXXXXXXXXXXXXXXX


-- Import module that has mapping details
...
function main(Data)
   ...
   local JSONTemplate = myDataModel.template()
   ...
   -- MsgOut.patient.application = 'test'
